...
sin:
    ...
    sin_loop:
            ...
            li s1, 1 # We do 1/1000 to insert 0.001 rest value
            fcvt.s.w fs2, s1
            li s2, 1000
            fcvt.s.w fs3, s2
            fdiv.s fs2, fs2, fs3
            flt.s s2, fa1, fs2 # Compara sub_pc con 0.001
            bnez s2, end_sin  # Si sub_pc >= 0.001, contin̼a el bucle
...
cos:
    ...
    cos_loop:
            ...
            fdiv.s fs2, fs2, fs3
            flt.s s2, fa1, fs2 # Compara sub_pc con 0.001
            bnez s2, end_cos  # Si sub_pc >= 0.001, contin̼a el bucle
...
tg: 
    ...
    li s0, 1 # We do 1/1000 to insert 0.001 rest value
    fcvt.s.w fs0, s0
    li s3, 1000
    fcvt.s.w fs3, s3
    fdiv.s fs2, fs0, fs3
